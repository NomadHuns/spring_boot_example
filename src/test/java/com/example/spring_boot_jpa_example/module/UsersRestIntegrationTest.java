...
@Transactional // 테스트 후 데이터 최화하기 위한 애노테이션
...
public class UsersRestIntegrationTest {
    @Autowired // Spring에서 의존성 주입(DI, Dependency Injection)을 자동으로 처리하는 애노테이션입니다. 테스트클래스에서는 해당 애노테이션을 사용하여 DI 하여야 문제가 발생하지 않습니다.
